...
class _PayBillsScreenState extends State<PayBillsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text(l10n.payBills, style: theme.titleLarge),
      ),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            if (_selectedCategory == l10n.bills)
              ListView.builder(
            ...
            else if (_selectedCategory == l10n.mobileBills)
              Padding(
                ...
                child: Card(
                  child: ExpansionTile(
                    ...
                    title: Text(l10n.mobileRecharge),
